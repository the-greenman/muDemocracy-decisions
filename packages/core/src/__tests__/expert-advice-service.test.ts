...
describe("ExpertAdviceService", () => {
  ...
  beforeEach(() => {
    ...
    service = new ExpertAdviceService(mockAdviceRepository, mockExpertTemplateRepository);
    vi.clearAllMocks();
  });
    ...
    it("should create advice from expert consultation", async () => {
      ...
      const expectedAdvice: ExpertAdvice = {
        ...
        advice: {
          ...
          concerns: ["Ensure all stakeholders are consulted before making a final decision."],
          questions: ["What is the timeline for this decision?", "What resources are available?"],
        },
        confidence: undefined,
        reasoning: undefined,
        mcpToolsUsed: [],
